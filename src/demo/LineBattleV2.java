...
// NOTE: identisk med LineBattle.java, på nær at spillet kører i et loop og afsluttes ved at variablen playingGame = false.
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  public void manCountPlayer() {
    if (soldiersComputer < 1) {
      ...
      playingGame = false; // NO MORE ENEMY SOLDIERS - PLAYER WINS
    }
  }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  public void computerReaction() {
    if (positionPlayer <= positionComputer && positionPlayer - positionComputer > 0) { //Computeren skyder hvis spilleren er foran dem og inden for 2 (i syne).
      ...
      forwardMoveComputer(); // default træk
    }
  }
  ...
  public void manCountComputer() {
    if (soldiersPlayer < 1) {
      ...
      playingGame = false; // NO MORE PLAYER SOLDIERS - COMPUTER WINS
    }
  }
